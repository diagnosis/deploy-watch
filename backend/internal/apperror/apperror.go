...
func (ae *AppError) Error() string {
	if ae.Err != nil {
		return fmt.Sprintf("%s: %s (%v)", ae.Code, ae.InternalMsg, ae.Err)
	}
	return fmt.Sprintf("%s: %s", ae.Code, ae.InternalMsg)
}
...
const DefaultPublicError = "Something went wrong"
